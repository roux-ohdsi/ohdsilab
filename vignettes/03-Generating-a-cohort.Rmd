...
Phenotype library (https://data.ohdsi.org/PhenotypeLibrary/). More details on generating
cohorts can be found here: https://ohdsi.github.io/CohortGenerator/ and here: https://ohdsi.github.io/TheBookOfOhdsi/Cohorts.html. 
...
Then, you might use this table (for example) to reduce the full person table to include only
...
to just the people that we're interested in, as defined by our cohort, and then calculates an age at entry. 
