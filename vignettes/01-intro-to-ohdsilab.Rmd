...
`Use renv with this project`. (If you forget, you can still activate {renv} by running `renv::activate()`
...
the data and ATLAS easier. 

First, set your credentials for the redshift database (db).
